    ...
    <div className ={globalStyles.section}>
      ...
      <div class={aboutStyles.grid}>
        <div class={aboutStyles.gridItem}>
          ...
          <p>
            I was fortunate and had some success with a mixed-media escape room experience ‘Quinn’, which premiered at Tribeca Film Festival, and was nominated for the prestigious <a href='https://futureofstorytelling.org/' target='_blank'>Future of Storytelling Prize</a> alongside companies like NASA and BBC. The room was set up in many different locations in 2016, and hundreds of people were able to participate. That work led to being able to create an immersive theatre experience off-Broadway about climate change (Refuge), which utilized (seemingly) unlimited Arduino and Raspberry Pi’s to make numerous magical interactions for the guests.
          </p>
          <p>
            Seeking to improve my coding skillset, I relocated to San Francisco to work at Apple as a frontend developer working full time on apple.com as a contractor through <a href='https://wearekettle.com/' target='_blank'>Kettle</a>. Working within the Apple campus, I learned a lot about making efficient, robust code and refined my ability to collaborate on a project and properly deploy it. After a couple of years of immense learning, I craved the prototyping, iterative design process of ITP. I was fortunate enough to be the first employee at a lab created by <a href="https://ideo.com/" target="_blank">IDEO</a> for <a href="https://www.orbia.com/" target="_blank">Orbia</a>, a global infrastructure company that has a purpose-driven mandate. My days were spent prototyping web and sensor-based apps, researching emerging technology, doing us- er-centered design with consumers, and preparing polished pitches to motivate the company to invest in projects that are “good for business and good for the world.”
          </p>
          <p>
